...
-- exp.mcp_tools: MCP tools discovered from configured MCP servers
-- Related: docs/data-model.md section 5.1
...
-- exp.variant_tools: Many-to-many relationship linking variants to MCP tools
-- Related: docs/data-model.md section 5.2
...
-- View: Variant tools with tool details
CREATE OR REPLACE VIEW exp.v_variant_tools AS
SELECT
    vt.*,
    t.name AS tool_name,
...
FROM exp.variant_tools vt
JOIN exp.mcp_tools t ON t.id = vt.tool_id;

-- =============================================================================
-- 8. FUNCTIONS (Optional helpers)
-- =============================================================================
